...
| `me-no-dev/ESPAsyncWebServer` | Async HTTP server |
| `me-no-dev/AsyncTCP` | Async TCP layer (required by above) |
...
*Built with ❤️ using PlatformIO, ESP32-Arduino, ESPAsyncWebServer, DHT sensor library, WiFiManager, and ArduinoJson.*

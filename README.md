...
This error occurs when **ESPAsyncWebServer** (including the esphome fork) and **WiFiManager** are included in the same source file on **espressif32 7.x / Arduino-ESP32 3.x**.
